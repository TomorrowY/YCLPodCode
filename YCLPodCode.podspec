...
Pod::Spec.new do |s|
  ...
  s.name         = "YCLPodCode"
  s.version      = "0.0.1"
  s.summary      = "YCLPodCode file"


  s.description  = "Custom TestPods description"

  s.homepage     = "https://github.com/TomorrowY/YCLPodCode"
  ...
  s.source       = { :git => "https://github.com/TomorrowY/YCLPodCode.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ToolClass/**/*.{h,m}", "Classes/**/*.{h,m}"
